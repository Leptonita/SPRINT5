        ...
        .then(jsonUrl => {
            ...
            fetch(jsonUrl.datos, {
                ...
                .then(json => {
                    ...
                    const tempThisHourArr = temperatureTodayHoursArr.filter((tItem: Titem) => tItem.periodo === nowHour.toString());
